...
//  header('Clear-Site-Data: "cache", "cookies", "storage", "executionContexts"');
    ...
    $pages = ['home','loginAdmin', 'Tableau', 'TableauJuriste', 'nouveauxJuristes','juristeListe','demandes','rendezVous', 'addUser','deleteAddJuriste','deleteUser','addDemande', 'confirmUser','loginUser','mesDemandes', 'logouat'];
